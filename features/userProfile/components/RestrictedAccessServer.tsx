        ...
        <div className='max-w-md w-full'>
          <div className='bg-[#12141D] rounded-3xl p-8 border border-red-900/30 shadow-xl'>
            <div className='flex flex-col items-center text-center space-y-6'>
              ...
              <div className='bg-slate-900/30 rounded-lg p-3 border border-slate-800/50 w-full text-slate-400 text-xs'>
                {statusMessage}
              </div>

              <div className='bg-[#E7C9A5]/5 border border-[#E7C9A5]/20 rounded-lg p-3 w-full text-slate-400 text-xs'>
                💌 Support Email:{" "}
